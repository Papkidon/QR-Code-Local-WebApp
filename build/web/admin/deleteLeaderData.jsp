...
<html>
    ...
    <body onload="displayResults()">
        <div id="mydiv">
            ...
            <form name="myForm" action="deleteLeaderData.jsp" method="POST">
                <table border="0">
                    <tbody>
                        <tr>
                            <td>ID Ucznia </td>
                            <td><select name="iducznia">
                                    ...
                                    <option value="<%= childrens.getInt("id")%>"><%= childrens.getInt("id")%> <%= childrens.getString("name")%> <%= childrens.getString("lastName")%> <%= childrens.getString("degree")%></option>
                                    <% }%>
                                </select></td>
                        </tr>
                    </tbody>
